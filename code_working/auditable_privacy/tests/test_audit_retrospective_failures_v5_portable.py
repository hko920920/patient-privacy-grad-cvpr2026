"""Three package-safe compatibility tests for the V5 retrospective bundle."""
...
def verify_portable(bundle: Path) -> dict:
    return verify(bundle, skip_internal_discovery_sources=True)


class RetrospectiveV5PortableCompatibilityTests(unittest.TestCase):
    def test_frozen_bundle_passes(self) -> None:
        result = verify_portable(FROZEN_BUNDLE)
