...
def main():
    ...
    head = '<section class="panel"><h2>최신 검토: CheXzero 한 대안의 근거·자산 확보</h2><p><a href="track1_chexzero_review.html"><strong>공식 질환별 근거·10개weight·새80명예약·중단선</strong></a> · <a href="track1_chexzero_review_protocol.html">사전 검토와 후속 검증 규칙</a></p><p>후보 준비에는 긍정적이며 NIH 성능은 아직 실행하지 않았습니다. 외부 PadChest의 폐기종AUC0.8232/기흉0.7659를 원자료에서 확인했고, 공식checkpoint10개3.29GiB를 확보·strict-load했습니다. 새모델forward/GPU/환자pixel접근은0입니다.</p><p>다음20–35분은 새환자80명의 고정 평가 한 번입니다. 어느target이라도 실패하면 추가classifier탐색을중단합니다. 새예약 후개발E-only44명이라기존64명/reference예시는유지불가하고32명/군을탐색계획으로정정했습니다. Reserved confirmation과기존실패는보존합니다. 아래최신/다음은이전이력입니다.</p></section>' + head
