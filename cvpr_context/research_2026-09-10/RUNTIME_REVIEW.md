...
| 기존 K10 cohort | 전체 환자 | 보유 기록 2장 이상 | 보유 기록 5장 이상 | K10 이미지 수 |
|---|---|---|---|---|
| members | 1816 | 865 | 304 | 4740 |
| nonmembers | 1816 | 865 | 304 | 4740 |
...
| 항목 | 학습 횟수 | 3070 기준 장치시간 | 근거 |
|---|---|---|---|
| M0 | 1 | 1–3 | 추정. 비DP batch 8; 장시간 완료 기록 없음 |
| M1-I8 | 1 | 4–6 | 4-step 17.562초; 단순 환산 4.88시간 |
| M1-G8 | 1 | 4–6 | 4-step 17.411초; 단순 환산 4.84시간 |
| M2-P8 | 1 | 3–5 | 4-step 7.945초; 단순 환산 2.21시간을 넓혀 예약 |
...
| 방법 | 연산량 검토 | 초/환자 가정 (빠름/중앙/느림) | 전체 장치시간 (빠름/중앙/느림) | 4대 환산시간, 중앙 |
|---|---|---|---|---|
| 고정 denoising loss | 20 F/장 (K10 기본); m=2에서 40 F | 1.0 / 2.0 / 4.0 | 5.8 / 11.5 / 23.1 | 3.6 |
| SecMI | 논문 stat 설정 약 12 NFE/장; SD2.1 adapter에 따라 확정 | 0.5 / 1.5 / 3.0 | 2.9 / 8.7 / 17.3 | 2.7 |
| CLiD | 경제형 설정 약 15 queries/장; prompt 정보 일치 | 1.0 / 2.0 / 5.0 | 5.8 / 11.5 / 28.8 | 3.6 |
| PFAMI | 20/110 queries/장 설정; 시간표는 높은 예산도 포함하는 가정 | 2.0 / 6.0 / 15.0 | 11.5 / 34.6 / 86.5 | 10.8 |
| GSA1/2·Tracing 묶음 | 선택 timestep의 F/B와 gradient feature; 세 방법의 가족 전체 예산 | 6.0 / 10.0 / 30.0 | 34.6 / 57.7 / 173.0 | 18.0 |
| CDI 환자 확장 | multiple loss 50 F/장 + gradient masking 20 F/10 B + 기타 score + L-BFGS 호출 | 5.0 / 12.0 / 30.0 | 28.8 / 69.2 / 173.0 | 21.6 |
| 교차 사진 probe | m=2: 312 F + 72 B / 환자 | 15.0 / 30.0 / 60.0 | 86.5 / 173.0 / 346.0 | 54.1 |
| MoFit 제한 예산 + 교차 사진 적용 | 원형과 별도인 제한 예산 비교; 원형 소규모 비교는 별도 계상 | 30.0 / 60.0 / 120.0 | 173.0 / 346.0 / 692.0 | 108.1 |
...
| 가정한 초/환자 | 1,730명×12모델 장치시간 | 4대·80% 환산시간 | 하루24시간 환산일 |
|---|---|---|---|
| 15 | 86.5 | 27.0 | 1.1 |
| 30 | 173.0 | 54.1 | 2.3 |
| 60 | 346.0 | 108.1 | 4.5 |
...
| 단계 | 작업 | 장치시간 빠름/중앙/느림 | 4대 환산시간 중앙 |
|---|---|---|---|
| setup | Spark 이식·환경/재시작 확인 | 4.0 / 8.0 / 16.0 | 2.5 |
| D1 | 새 feature/probe 구현 점검 | 2.0 / 6.0 / 12.0 | 1.9 |
| D2_train | 공개 비DP 모델 2개 × 1000 steps | 0.5 / 1.0 / 2.0 | 0.3 |
| D2_pilot | 256명 × 2모델 첫 진단 | 3.6 / 7.6 / 15.7 | 2.4 |
| D3_baselines | 200명 × 2모델 baseline 개발 평가 1회 | 6.7 / 13.7 / 29.7 | 4.3 |
| D3_ablations | 개발 제거 실험·공정성 진단 | 8.0 / 16.0 / 40.0 | 5.0 |
| D3_mofit_full | MoFit 원형 800 이미지 평가 | 100.0 / 200.0 / 400.0 | 62.5 |
| K10_core | K10 핵심 12회 학습 | 36.0 / 48.0 / 60.0 | 15.0 |
| K10_extra | A0/A1/A2 + P4 각 1회 예산 | 11.0 / 15.0 / 19.0 | 4.7 |
| K10_quality | 소규모 품질 생성·특징·검증 | 3.0 / 6.0 / 12.0 | 1.9 |
| K10_mia | 기존 기본 MIA·B0 및 추가모델 | 16.0 / 40.0 / 80.0 | 12.5 |
| K10_extraction_gen | 17모델 ×2450 추출용 생성 | 9.3 / 12.6 / 23.1 | 3.9 |
| K10_extraction_filter | 추출 대조·검색·후보 확인 | 6.0 / 12.0 / 30.0 | 3.8 |
| D4_E2 | E m=2 1730명 ×12모델 전체 비교 | 348.9 / 712.2 / 1,539.7 | 222.6 |
| D4_ablations | 최종 제거 실험 6모델·후보 2회 상당 예산 | 86.5 / 173.0 / 346.0 | 54.1 |
| D4_fit | Quantile·Deep Sets·moments fitting | 2.0 / 6.0 / 12.0 | 1.9 |
| D5_utility | 5천장/모델 ×12 생성, classifier39회 | 34.8 / 61.1 / 117.3 | 19.1 |
| D5_stats | 통계·보호 비교 보조 GPU | 0.0 / 1.0 / 3.0 | 0.3 |
| D4_E5 | E m=5 608명 ×12모델 전체 비교 | 306.5 / 625.7 / 1,352.8 | 195.5 |

| 처리량 시나리오 | m=2 중심 전체 장치시간 | 4대 환산일 | m=5 본표까지 장치시간 | 4대 환산일 |
|---|---|---|---|---|
| 작업이 빠른 경우 | 678.3 | 8.8 | 984.9 | 12.8 |
| 중앙 계획값 | 1,339.2 | 17.4 | 1,964.9 | 25.6 |
| 작업이 느린 경우 | 2,757.5 | 35.9 | 4,110.3 | 53.5 |
...
| Spark 대수 | 하루 사용시간 | 하루 유효 장치시간 | m=2 중심 중앙 환산일 | m=5 포함 중앙 환산일 |
|---|---|---|---|---|
| 4 | 24 | 76.8 | 17.4 | 25.6 |
| 4 | 16 | 51.2 | 26.2 | 38.4 |
| 4 | 8 | 25.6 | 52.3 | 76.8 |
| 2 | 24 | 38.4 | 34.9 | 51.2 |
| 1 | 24 | 19.2 | 69.7 | 102.3 |
