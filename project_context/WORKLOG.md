...
계약/검사/두bank/평가 완료. 보고서: RECEIVER_SEED202_REPLICATION_RESULTS_20260923.md. 추가 실행 없음.


## 2026-09-23 — A2 공개전용 대조

A2 P-only128장·200회·seed101 완료. DenseNet AUROC/AP P 0.542669/0.053838 대 P+Q 0.671734/0.078565. Q 추가 차이 +0.129065(CI[+0.088112,+0.174088]) / +0.024728(CI[+0.008428,+0.041644]). BioViL P 0.714645/0.077790, P+Q 차이 구간은AUROC/AP 모두0포함. P 분모669/6 검산오차0·기존 초기상태 exact·최종PNG 검사 통과. 합성74.35분, 평가11.13초. Q 추가 가치의 긍정적 단일seed 비DP 개발 근거이며 DP/독립 확인은 미실행. 기존 결과 보존, 추가 실행 없음.
...
보고서: RECEIVER_A2_PUBLIC_CONTROL_RESULTS_20260923.md


## 2026-09-23 — A2 공개전용 seed202 반복

A2 공개전용 seed202 128장·200회·microbatch16 학습/PNG/개발 평가 완료. DenseNet P→P+Q AUROC: seed101 0.542669→0.671734 (+0.129065), seed202 0.563388→0.670355 (+0.106967;95% CI[+0.053575,+0.161466]). 두 seed 모두 AUROC 이득 반복, AP 점추정도 양수이나202 AP CI는0 포함. 새 합성·저장73.91분. 목표/초기 상태 동일성 및 역사적 결과 보존 검증 통과. DP/추가 bank/Expert/Reserved 미실행.
...
## 2026-09-23T15:23:33.465908+00:00 — A2 독립 DP 잡음 반복 완료
...
작업 시작→평가 완료 82.53분. 보고서: RECEIVER_PATIENT_DP_NOISE_REPEAT_RESULTS_20260923.md
...
## 2026-09-24T09:51:06.983725+00:00 — Feature follow-up complete
